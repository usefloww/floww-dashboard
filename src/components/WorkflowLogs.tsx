...
import { WorkflowLogsResponse, LogLevel } from "@/types/api";
...
export function WorkflowLogs({ workflowId }: WorkflowLogsProps) {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ["workflow-logs", workflowId, searchQuery, levelFilter],
    queryFn: async () => {
      ...
      return await api.get<WorkflowLogsResponse>(
  ...
  return (
    <Loader isLoading={isLoading} loadingMessage="Loading logs...">
